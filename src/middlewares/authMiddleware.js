...
var supabaseServerClient_js_1 = require("../utils/supabaseServerClient.js");
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, supabaseServerClient_js_1.supabase.auth.getUser(token)];
                case 2:
                ...
                case 3:
                    error_1 = _c.sent();
                    console.error('Auth verification error:', error_1);
                    return [2 /*return*/, res.status(401).json({
                            success: false,
...
function verifyResourceOwnership(req, res, next) {
    ...
    var authenticatedUserId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
    ...
    if (requestedUserId === authenticatedUserId || ((_b = req.user) === null || _b === void 0 ? void 0 : _b.role) === 'admin') {
        return next();
    }
